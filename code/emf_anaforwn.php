...
<form  enctype=multipart/form-data class="col-lg-4" method="post" action="diagrafh_anaforas.php"  style="float:center" >
    
      <div class="form-group">
          <input type="text" class="form-control input-lg" placeholder="Όνομα" name="name">
...
$result3 = mysqli_query($con,"SELECT * FROM anafores  ");
$count=1;
?>
<div id="section">
<?php
